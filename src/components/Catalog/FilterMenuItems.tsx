...
export const FilterMenuItems = ({ heading, elements, type }: IFilterMenu) => {
  ...
  const handleDrop = (e: MouseEvent<HTMLHeadingElement>, id: string) => {
